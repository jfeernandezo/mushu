...
const badgeVariants = cva(
  'inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-medium transition-colors',
  {
    variants: {
      variant: {
        default:
          'border-transparent bg-[var(--color-mushu-scarlet)]/15 text-[var(--color-mushu-accent-text)]',
        success:
          'border-transparent bg-[var(--color-mushu-success)]/15 text-[var(--color-mushu-success)]',
        warning:
          'border-transparent bg-[var(--color-mushu-amber)]/15 text-[var(--color-mushu-warning)]',
        danger:
